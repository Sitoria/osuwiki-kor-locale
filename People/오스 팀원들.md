...
| ::{ flag=PH }:: [Nathanael](https://osu.ppy.sh/users/2295078) | 총괄 관리자, moderation advisor |
...
| ::{ flag=ES }:: [Trosk-](https://osu.ppy.sh/users/3469385) | 총괄 관리자, tournament assistant |
...
| ::{ flag=US }:: [HappyStick](https://osu.ppy.sh/users/256802) | osu! Coffee Hour 호스트, 월드컵 방송인, tournament organizer |
