...
| ::{ flag=JP }:: [flyte](https://osu.ppy.sh/users/3103765) | 디자인 책임자, resident Creative Cloud watcher |
...
| ::{ flag=US }:: [pishifat](https://osu.ppy.sh/users/3178418) | Modding and mapping scene advisor, Mappers' Guild 주최자, 공식 아티스트 지원 |
| ::{ flag=US }:: [radar](https://osu.ppy.sh/users/7131099) | Modding and mapping scene advisor |
| ::{ flag=MX }:: [Repflez](https://osu.ppy.sh/users/201392) | General housekeeper, 위키 관리자 |
| ::{ flag=FR }:: [Shiro](https://osu.ppy.sh/users/113005) | General housekeeper |
| ::{ flag=AU }:: [smoogipoo](https://osu.ppy.sh/users/1040328) | osu! 개발자, osu!mania lover, 버그 관련 담당자 |
...
| ::{ flag=NZ }:: [Echo](https://osu.ppy.sh/users/431) | osu! 개발자, provider of IRC integration for in-game chat, 사이트 관리자. [블로그](http://blog.echo.sh/) |
| ::{ flag=US }:: [HappyStick](https://osu.ppy.sh/users/256802) | osu! Coffee Hour host, 월드컵 방송인, tournament organizer |
...
| ::{ flag=DE }:: [Loctav](https://osu.ppy.sh/users/71366) | 월드컵 주최자 및 관리자, QAT 책임자, community manager |
...
| ::{ flag=GR }:: [Sinistro](https://osu.ppy.sh/users/5530) | 초창기 커뮤니티 매니저 및 리더, meeting minutes and FAQ contributor |
| ::{ flag=DE }:: [Tom94](https://osu.ppy.sh/users/1857058) | osu!와 pp 개발자 |
| ::{ flag=US }:: [Toy](https://osu.ppy.sh/users/2757689) | Project Loved 매니저, community advisor, 공식 아티스트 지원 |
| ::{ flag=CA }:: [VINXIS](https://osu.ppy.sh/users/4323406) | Modding and mapping scene advisor |
| ::{ flag=CL }:: [WalterToro](https://osu.ppy.sh/users/5281416) | General housekeeper, 월드컵 주최자 및 관리자, 위키 관리자 |
...
| ::{ flag=US }:: [ztrot](https://osu.ppy.sh/users/6347) | [osu!academy](/wiki/Community/Video_series/osu!academy) professor, 미디어 및 캐릭터 디자이너 |
